...
public class Manager extends javax.swing.JFrame {
    ...
    public Manager(String name,String no ,String email) {
        this.Name = name;
        this.phoneNum = no;
        this.email = email;
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel6.setBackground(new java.awt.Color(2, 22, 38));
        ...
        jPanel5.setBackground(new java.awt.Color(2, 22, 38));
        ...
        Done.setBackground(new java.awt.Color(2, 28, 30));
        Done.setFont(new java.awt.Font("Trebuchet MS", 1, 28)); // NOI18N
        ...
        jButton3.setText("Get More Details ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(adult == 0 && child == 0){
            ...
            String query="insert into travellog (name,num,start,end,fare,email) values('"+this.Name+"','"+this.phoneNum+"','"+dest+"','"+Arr+"','"+(hotelRate + totalFare)+"','"+this.email+"')";
            try{
                theQuery(query);
